...
from operator_learning.data.pysdc_dataset import createDatasetFromPySDC
...
parser.add_argument(
    "--dataDir", default="Data", help="directory containing simulation data")
parser.add_argument(
...
parser.add_argument(
    "--iBeg", default=100, help="starting index of data sample", type=int)
parser.add_argument(
...
parser.add_argument(
    "--inStep", default=1, help="input step", type=int)
parser.add_argument(
